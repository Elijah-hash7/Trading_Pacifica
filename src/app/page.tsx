...
import { TrendingUp, TrendingDown, Send, ArrowLeftRight, Search, X, ChevronDown } from 'lucide-react';
  ...
  return (
    <>
      <div className="min-h-screen bg-black text-white pb-32">
        ...
        <header className="px-5 pt-4 pb-3 flex justify-between items-center">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="w-9 h-9 rounded-full bg-zinc-900 flex items-center justify-center hover:cursor-pointer"
            >
        ...
        {connectWalletError && (
          <div className="fixed left-4 right-4 top-1/2 -translate-y-1/2 z-50">
            <div className="mx-auto w-full max-w-sm rounded-xl border border-zinc-700/60 bg-zinc-900/95 text-zinc-100 px-3 py-2 text-sm flex items-center justify-between gap-2 shadow-lg backdrop-blur">
              <span>{connectWalletError}</span>
              <div className="flex items-center gap-3 shrink-0">
                <a
                  href="https://warpcast.com"
                  target="_blank"
                  rel="noreferrer"
                  className="text-xs font-medium text-zinc-100 underline"
                >
                  Open Warpcast
                </a>
                <button
